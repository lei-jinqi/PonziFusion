...
baselines = {
    ...
    'MTCFormer': {
        'Precision': [0.9132, 0.9084, 0.9121, 0.9150, 0.9107, 0.9143, 0.9129, 0.9098, 0.9116, 0.9102],
        'Recall': [0.7314, 0.7368, 0.7341, 0.7289, 0.7332, 0.7297, 0.7308, 0.7326, 0.7337, 0.7344],
        'F1': [0.8078, 0.8126, 0.8094, 0.8151, 0.8065, 0.8112, 0.8140, 0.8087, 0.8103, 0.8084],
        'ROC-AUC': [0.9448, 0.9462, 0.9417, 0.9435, 0.9451, 0.9428, 0.9460, 0.9454, 0.9420, 0.9426],
        'AUC-PR': [0.8336, 0.8369, 0.8291, 0.8348, 0.8382, 0.8339, 0.8364, 0.8371, 0.8328, 0.8304]
    },
    'SADPonzi': {
        'Precision': [0.5484, 0.5625, 0.5333, 0.5714, 0.5400, 0.5862, 0.5217, 0.5556, 0.5682, 0.5581],
        'Recall': [0.5312, 0.5000, 0.5517, 0.5161, 0.5400, 0.5312, 0.5000, 0.5556, 0.5208, 0.5333],
        'F1': [0.5397, 0.5294, 0.5424, 0.5424, 0.5400, 0.5574, 0.5106, 0.5556, 0.5435, 0.5455],
        'ROC-AUC': [0.7548, 0.7426, 0.7615, 0.7489, 0.7562, 0.7694, 0.7318, 0.7751, 0.7586, 0.7527],
        'AUC-PR': [0.4147, 0.3975, 0.4268, 0.4092, 0.4211, 0.4526, 0.3814, 0.4437, 0.4285, 0.4196]
    },
}
